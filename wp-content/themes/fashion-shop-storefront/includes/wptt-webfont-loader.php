...
if ( ! class_exists( 'Fashion_Shop_Storefront_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Fashion_Shop_Storefront_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Fashion_Shop_Storefront_WPTT_WebFont_Loader( $url );
