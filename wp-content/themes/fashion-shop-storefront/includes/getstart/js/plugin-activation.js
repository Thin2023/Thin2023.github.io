jQuery(document).ready(function($) {
    'use strict';
    var this_obj = fashion_shop_storefront_plugin_activate_plugin;

    $('#wpelemento_importer_editor .plugin-activation-redirect a').addClass('wpi-redirect-to-dashboard');

    $(document).on('click', '.fashion-shop-storefront-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message fashion-shop-storefront-plugin-install');
                button.addClass('button-primary fashion-shop-storefront-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.fashion-shop-storefront-recommended-plugins .fashion-shop-storefront-activation-note').css('display','block');
    ...
    $(document).on('click', '.fashion-shop-storefront-plugin-activate', function(event) {
