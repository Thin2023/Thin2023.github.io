  ...
  <div id="post-<?php the_ID(); ?>" <?php post_class('post-box mb-4'); ?>>
    <div class="box">
      <div class="post-thumbnail">
        ...
        <?php } else { ?>
          <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/post-dummy.png' ); ?>" alt="<?php esc_attr_e( 'Post Image', 'fashion-shop-storefront' ); ?>">
         <?php }?>
      </div>
      <div class="box-content">
        <p class="slider-button mb-0">
          <a href="<?php echo esc_url(get_permalink($post->ID)); ?>"><?php esc_html_e('Read More','fashion-shop-storefront'); ?><i class="fas fa-angle-right ml-2"></i></a>
        </p>
      </div>
    </div>
    <div class="post-content-box p-3">
        ...
        <?php echo wp_trim_words( get_the_content(), get_theme_mod('fashion_shop_storefront_length_setting','15')); ?>
        </div>
        <div class="post-info">
